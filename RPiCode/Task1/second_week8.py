...
def translate_and_dispatch(cmds: list[str]):
...
class RaspberryPi:
    ...
    def request_algo(self, data, robot_x=1, robot_y=1, robot_dir=0, retrying=False):
        ...
        translate_and_dispatch(commands)
