...
class RaspberryPi:
    ...
    def translate_and_dispatch(self, cmds, on_fin=None):
        """
        ...
        def do_snap(snap_token: str):
            ...
            try:
                ...
                if self.android_link:
                    self.android_link.send(AndroidMessage("image-rec", result))
    ...
    def start(self):
        ...
        try:
            ...
            ##self.shortcut_obstacle_place("{"cat":"obstacles","value":{"obstacles":[{"x":1,"y":16,"id":1,"d":2},{"x":5,"y":11,"id":2,"d":0}],"mode":"0"}")
    ...
    def shortcut_obstacle_place(self,msg_str:str):
    ...
    def request_algo(self, data, robot_x=1, robot_y=1, robot_dir=0, retrying=False):
        ...
        self.translate_and_dispatch(commands, on_fin=lambda: self.rpi_action_queue.put(PiAction(cat="stitch", value="")))
    ...
    def handle_keyboard_input(self):
        ...
        while True:
            ...
            if "shortcut" in user_input:
                user_input = input("Paste obstacles: ")
                self.shortcut_obstacle_place(user_input)
                ...
                while exitflag == False:
                    ...
                    if user_input[0:2] == "fw":
                        if user_input == "fw":
                            ...
                            if int(user_input[2:])>90:
                                print("Moving backward 90 cm")
                                robot.move_forward(90)
                            else:
