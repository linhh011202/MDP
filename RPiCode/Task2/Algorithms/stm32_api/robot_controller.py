...
class RobotController:
    ...
    def move_forward_but_actually_move_to_o1(self, dist: int, no_brakes: bool = False) -> bool:
    ...
    def move_backward_but_actually_zero_o2_left_one_o2_right(self, dist: int, no_brakes: bool = False) -> bool:
        if dist < 0 or dist > 999:
            raise ValueError("Invalid distance, must be 0-999")
    ...
    def turn_left_but_actually_dodge_o1_left(self, angle: int, dir: bool, no_brakes: bool = False) -> bool:
    ...
    def turn_right_but_actually_dodge_o1_right(self, angle: int, dir: bool, no_brakes: bool = False) -> bool:
        if angle < 0 or angle > 359:
            raise ValueError("Invalid angle, must be 0-359")
    ...
    def Sonny_Move_To_O1(self):
        self.drv.construct_cmd()
        self.drv.add_cmd_byte(True)
        self.drv.add_module_byte(self.drv.Modules.MOTOR)
        self.drv.add_motor_cmd_byte(self.drv.MotorCmd.SONNY_MOVE_TO_O1_CHAR)
        self.drv.pad_to_end()
        return self.drv.ll_is_valid(self.drv.send_cmd())

    def Sonny_Dodge_O1_Left(self):
        self.drv.construct_cmd()
        self.drv.add_cmd_byte(True)
        self.drv.add_module_byte(self.drv.Modules.MOTOR)
        self.drv.add_motor_cmd_byte(self.drv.MotorCmd.SONNY_DODGE_O1_LEFT_CHAR)
        self.drv.pad_to_end()
        return self.drv.ll_is_valid(self.drv.send_cmd())
    
    def Sonny_Dodge_O1_Right(self):
        self.drv.construct_cmd()
        self.drv.add_cmd_byte(True)
        self.drv.add_module_byte(self.drv.Modules.MOTOR)
        self.drv.add_motor_cmd_byte(self.drv.MotorCmd.SONNY_DODGE_O1_RIGHT_CHAR)
        self.drv.pad_to_end()
        return self.drv.ll_is_valid(self.drv.send_cmd())
    
    def Sonny_Dodge_O2_Left_And_Home(self):
        self.drv.construct_cmd()
        self.drv.add_cmd_byte(True)
        self.drv.add_module_byte(self.drv.Modules.MOTOR)
        self.drv.add_motor_cmd_byte(self.drv.MotorCmd.SONNY_DODGE_O2_LEFT_AND_HOME_CHAR)
        self.drv.pad_to_end()
        return self.drv.ll_is_valid(self.drv.send_cmd())
    
    def Sonny_Dodge_O2_Right_And_Home(self):
        self.drv.construct_cmd()
        self.drv.add_cmd_byte(True)
        self.drv.add_module_byte(self.drv.Modules.MOTOR)
        self.drv.add_motor_cmd_byte(self.drv.MotorCmd.SONNY_DODGE_O2_RIGHT_AND_HOME_CHAR)
        self.drv.pad_to_end()
        return self.drv.ll_is_valid(self.drv.send_cmd())
    ...
    def wait_until_idle(self, timeout_s: float = 60.0):
        ...
        while time.time() - start_time < timeout_s:
            if not self.is_busy():
                print("Robot is idle.")
                return True
            time.sleep(0.2) # Poll 10 times per second
