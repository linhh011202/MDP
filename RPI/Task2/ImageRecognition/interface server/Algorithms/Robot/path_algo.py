...
from Algorithms.Map import RobotPosition
from Algorithms.Map import Grid
from Algorithms.Map import Node
...
class ModifiedAStar:
    ...
    def get_neighbours(self, pos: RobotPosition) -> List[Tuple[Node, RobotPosition, int, Command]]:
        ...
        turn_commands = [
            TurnCommand(90, False),  # Forward right turn TODO Confirm directions
